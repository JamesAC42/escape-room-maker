...
class EventWindowBind extends Component {
  constructor(props) {
    ...
    this.props.create.graph.startRoom = Object.keys(
      this.props.create.graph.graph
    )[0];
    this.props.create.graph.endRoom = Object.keys(
      this.props.create.graph.graph
    )[0];
    this.props.create.graph.graph[
  ...
  // sets the event type
  eventChoose = (e) => {
    this.state.roomVals.find(
      (x) => x.room == this.props.create.activeRoom
  ...
  selectForEvent = (e) => {
    console.log(
      "\n\n\ncurrentSelected is about to be",
      e.target.value,
      "\n\n\n"
    );
    this.setState({
  ...
  mapGraph = () => {
    ...
    console.log(
      this.props.create.graph == undefined
        ? "graph und"
        : "rooms: " + Object.keys(this.props.create.graph.graph)
    );
    if (this.props.create.graph) {
      if (this.state.roomVals == null) {
        console.log("typeof", typeof this.props.create.graph.graph);
        this.state.roomVals = Object.keys(this.props.create.graph.graph).map(
          (x) => ({
            room: x,
            eventType: "No Event",
            requireItem: false,
        ...
        if (
          this.state.roomVals.length !=
          Object.keys(this.props.create.graph.graph).length
        ) {
  ...
  setInitRenderVals = () => {
    if (this.state.roomVals !== null && this.props.create.activeRoom) {
      if (this.state.currentSelected == "Room") {
        var currSelect = this.state.roomVals.find(
          (x) => x.room == this.props.create.activeRoom
        );
      } else {
        var currSelect = this.state.roomVals
          .find((x) => x.room == this.props.create.activeRoom)
  ...
  setEWInputs = () => {
    if (this.state.roomVals !== null && this.props.create.activeRoom) {
      ...
      document.getElementById("req-item-choice").checked =
        currSelect.requireItem;
      document.getElementById("req-item-name").value =
        currSelect.requireItemName;
      document.getElementById("event-desc").value = currSelect.eventDesc;
      document.getElementById("solve-item-choice").checked =
        currSelect.solveItem;
      document.getElementById("solve-item-name").value =
        currSelect.solveItemName;
      document.getElementById("solve-item-desc").value =
        currSelect.solveItemDesc;
    }
  };
      ...
      if (Object.keys(newGraph.coordinates).length > 2) {
        this.combinations.forEach((c) => {
          Object.entries(this.props.create.graph.coordinates).forEach((r) => {
            console.log(
              `x=${coords.x + c[0]} y=${coords.y + c[1]} r.x=${r[1].x} r.y=${
                r[1].y
              }`
            );
      ...
      >
          ...
          <div style={{ float: "right" }}>
            <input
              ...
              style={{
                width: "6rem",
                backgroundColor:
                  this.state.currentSelected == "Room" ? "#8ffad1" : "",
                borderColor:
                  this.state.currentSelected == "Room" ? "#6fdab1" : "",
              }}
            />
            <input
              className="direction-button"
              ...
              style={{
                backgroundColor:
                  this.state.currentSelected == "N" ? "#8ffad1" : "",
                borderColor: this.state.currentSelected == "N" ? "#6fdab1" : "",
              }}
            />
            <input
              className="direction-button"
              ...
              style={{
                backgroundColor:
                  this.state.currentSelected == "S" ? "#8ffad1" : "",
                borderColor: this.state.currentSelected == "S" ? "#6fdab1" : "",
              }}
            />
            <input
              className="direction-button"
              ...
              style={{
                backgroundColor:
                  this.state.currentSelected == "W" ? "#8ffad1" : "",
                borderColor: this.state.currentSelected == "W" ? "#6fdab1" : "",
              }}
            />
            <input
              className="direction-button"
              ...
              style={{
                backgroundColor:
                  this.state.currentSelected == "E" ? "#8ffad1" : "",
                borderColor: this.state.currentSelected == "E" ? "#6fdab1" : "",
              }}
            />
          </div>
        </h1>
        ...
        <div style={{ float: "right" }}>
          <input
            ...
            style={{
              backgroundColor:
                this.state.start == this.props.create.activeRoom
                  ? "#8ffad1"
                  : "",
              borderColor:
                this.state.start == this.props.create.activeRoom
          ...
          <input
            ...
            style={{
              backgroundColor:
                this.state.end == this.props.create.activeRoom ? "#8ffad1" : "",
              borderColor:
                this.state.end == this.props.create.activeRoom ? "#6fdab1" : "",
            }}
          />
        </div>
        ...
        <div
          style={
            this.state.event_type !== "No Event"
              ? styles.styleVisible
              : styles.styleHidden
          }
        >
          ...
          <div
            style={
              this.state.item_req && this.state.event_type !== "No Event"
                ? styles.styleVisible
                : styles.styleHidden
            }
          >
          ...
          <div
            style={
              this.state.item_solve && this.state.event_type !== "No Event"
                ? styles.styleVisible
                : styles.styleHidden
            }
          >
